...
var budgetController = (function() {
    ...
    return {
        addItem: function(type, des, val) {
            ...
            // Crate new item based on 'onc' or 'exp' type
            if (type === 'exp') {
        ...
        calculateBudget: function() {
            ...
            if(data.totals.inc > 0) {
                ...
                // Expemse = 100 and income 200, spent 50% = 100/200 = 0.5 * 100
            } else {
                data.percentage = -1;
            }
        },
...
var UIController = (function() {
    ...
    var formatNumber = function(num, type){
		...
		*/
        ...
        int = numSplit[0];
        if(int.length > 3) {
            int = int.substr(0,int.length - 3) + ',' + int.substr(int.length - 3, int.length); //2310 -> 2,310 23510 -> 23,510
        }
